...
Begin VB.Form BuscarAutorizacionDePagoFF 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Buscar Autorización de Pago Para Fondo Fijo"
   ClientHeight    =   6915
   ClientLeft      =   3225
   ClientTop       =   2250
   ClientWidth     =   11730
   ...
   End
End
Attribute VB_Name = "BuscarAutorizacionDePagoFF"
   ...
   If .RecordCount > 0 Then
      For i = 1 To .RecordCount
        If ValN(!A_FondoFijoNro) > 0 Then
            ...
            LvListado.ListItems(LvListado.ListItems.Count).SubItems(3) = VerificarNulo(!A_FondoFijoNro)
            LvListado.ListItems(LvListado.ListItems.Count).SubItems(4) = IIf(IsNull(!A_FechaAnulacion), "", Format(!A_FechaAnulacion, "dd/MMM/yyyy HH:mm"))
            LvListado.ListItems(LvListado.ListItems.Count).SubItems(5) = !A_Observaciones
        End If
        .MoveNext
      Next
    End If
...
Private Sub CrearEncabezado()
    ...
    LvListado.ColumnHeaders.Add , , "Fondo Fijo Nº", 1200
    LvListado.ColumnHeaders.Add , , "F. de Anulación", 1400
    LvListado.ColumnHeaders.Add , , "Observaciones", LvListado.Width - 8200
End Sub
...
Private Sub LVListado_DblClick()
    A01_4500.NroAutorizacion = Val(LvListado.SelectedItem.Text)
    Unload Me
End Sub
