...
Begin VB.Form A01_5712 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Acumulado Por Sub-Cento de Costo"
   ClientHeight    =   7245
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6675
...
On Error GoTo Error
    ...
    'Realiza la consulta
    Sql = "SpOcConsultaDetallePorCuentaContableSGPAcumularSubCentro @Periodo =" & FechaSQL(CStr(Periodo), "SQL") & _
    ...
    With RsCargar
      ...
      LVListado.Sorted = False
        While Not .EOF
            ...
            LVListado.ListItems(i).Text = !R_CentroDeCosto
            LVListado.ListItems(i).SubItems(1) = BuscarDescCentro(!R_CentroDeCosto)
