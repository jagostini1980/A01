...
On Error GoTo Error
    ...
    'Realiza la consulta
    Sql = "SpOcConsultaPresupuestoFinancieroDetalleContable @Periodo = " & FechaSQL(CStr("01/" & Format(Periodo, "MM/yyyy")), "SQL") & _
                                                         ", @Rubro = '" & Rubro & "'"
    ...
    With RsCargar
      ...
      LVListado.Sorted = False
        While Not .EOF
            ...
            LVListado.ListItems(i).SubItems(1) = Format(!Importe, "#,##0.00")
...
Private Sub ConfImpresionDeConsulta()
  ...
  Dim RsListado As New ADODB.Recordset
    ...
    ListA01_5910.TxtPeriodo.Text = Format(Periodo, "MMMM/yyyy")
    ListA01_5910.DataControl1.Recordset = RsListado
    ListA01_5910.Zoom = -1
End Sub
...
Private Sub LVListado_DblClick()
    A01_5911.Cuenta = LVListado.SelectedItem.SubItems(2)
    A01_5911.Periodo = Periodo
    A01_5911.LbTitulo = LVListado.SelectedItem.Text
    A01_5911.Show vbModal
End Sub
