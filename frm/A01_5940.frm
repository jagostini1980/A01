...
Begin VB.Form A01_5940 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Detalle Cobrenzas turismo"
   ClientHeight    =   8055
   ClientLeft      =   -4710
   ClientTop       =   -1755
   ClientWidth     =   8535
   ...
   Begin DDSharpGrid2.SGGrid GridListado 
      ...
      StylesCollection=   $"A01_5940.frx":0000
      ColumnsCollection=   $"A01_5940.frx":1DD9
      ValueItems      =   $"A01_5940.frx":35AC
   End
...
Public Sub Traer(FechaDesde As String, FechaHasta As String)
'On Error GoTo Errores
Dim Sql As String
Dim i As Integer
...
Dim Total As Double
    ...
    Sql = "SpOcConsultaPresupuestoFinancieroIngresosRealDetalleTurismo @FechaDesde=" & FechaSQL(FechaDesde, "SQL") & _
                                                                    ", @FechaHasta=" & FechaSQL(FechaHasta, "SQL")
    ...
    With TbListado
        ...
        While Not .EOF
            '        MONEDAK ImporteUss
            GridListado.Array(i, 0) = !Fecha
            GridListado.Array(i, 1) = !Comprobante
            GridListado.Array(i, 2) = !CONCEPTO
            GridListado.Array(i, 3) = Format(ValN(!Importe), "#,##0.00")
             Total = Total + ValN(!Importe)
             i = i + 1
            .MoveNext
        Wend
        .Close
