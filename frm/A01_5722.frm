...
Begin VB.Form A01_5722 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Acumulado Por Sub-Centro de Costo"
   ClientHeight    =   7245
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6675
...
On Error GoTo Error
    ...
    'Realiza la consulta
    Sql = "SpOcConsultaDetallePorCuentaContableAcumularSubCentro @Periodo ='" & Format(Periodo, "MM/yyyy") & _
    ...
    With RsCargar
      ...
      LVListado.Sorted = False
        While Not .EOF
            ...
            LVListado.ListItems(i).Text = BuscarCodigoPorCodSecundario(Format(!C_Rubro, "000"))
            LVListado.ListItems(i).SubItems(1) = BuscarDescCentroPorCodSecundario(Format(!C_Rubro, "000"))
...
On Error GoTo Error
  ...
  If MenuEmisionOrdenCompra.Cuadros.FileName <> "" Then
        ...
        'guarda la orden de compra como un PDF
         ...
         myPDFExport.Export ListA01_5722.Pages
         Unload ListA01_5722
  End If
Error:
...
Private Sub CrearEncabezado()
    LVListado.ColumnHeaders.Add , , "Cod. Sub-Centro", 1000
    LVListado.ColumnHeaders.Add , , "Sub-Centro de Costo ", LVListado.Width - 2350
    LVListado.ColumnHeaders.Add , , "Importe", 1100, 1
    LVListado.ColumnHeaders.Add , , "CodSubCentro", 0, 1
End Sub
  ...
  Set RsListado = New ADODB.Recordset
    ...
    While i <= LVListado.ListItems.Count
      ...
      With LVListado.ListItems(i)
           ...
           RsListado!SubCentro = .SubItems(1)
    ...
    ListA01_5722.TxtCuentaCostable.Text = BuscarDescCta(Cuenta)
    ListA01_5722.TxtCentro.Text = BuscarDescCentroEmisor(CentroEmisor)
    ListA01_5722.TxtPeriodo.Text = Format(Periodo, "MMMM/yyyy")
    ListA01_5722.DataControl1.Recordset = RsListado
    ListA01_5722.Zoom = -1
End Sub
