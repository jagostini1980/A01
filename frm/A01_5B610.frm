...
Begin VB.Form A01_5B610 
   ...
   Begin DDSharpGrid2.SGGrid GridListado 
      ...
      StylesCollection=   $"A01_5B610.frx":0000
      ColumnsCollection=   "A01_5B610.frx":1DD9
      ValueItems      =   $"A01_5B610.frx":6089
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   0
      Width           =   10425
      Begin VB.TextBox TxtCentroEmisor 
         Enabled         =   0   'False
         Height          =   315
         Left            =   1425
         TabIndex        =   9
...
On Error GoTo ErrorTraer:
  With RsListado
     '******** Detalle Gastos Por Cuenta ***********
      Sql = "Admin.ElPulquiAdministracion.dbo.SpOcGastosResultadoEconomicoPorCentroDeCostoDetalle @PerGasto='" & Format(CalDesde, "MMyy") & _
                                                      "', @CentroEmisor ='" & Jerarquia & _
                                                      "', @Cuenta='" & Cuenta & _
                                                      "', @SuCentro='" & SubCentro & "'"
     ...
     If .RecordCount > 0 Then
        ...
        For i = 1 To .RecordCount
            ...
            GridListado.Array(GridListado.DataRowCount - 1, 2) = BuscarDescCentro(BuscarCodigoPorCodSecundario(Format(Trim(!C_Rubro), "000")))
            GridListado.Array(GridListado.DataRowCount - 1, 3) = Format(VerificarNulo(!C_Importe, "N"), "#,##0")
    ...
    GridListado.Array(GridListado.DataRowCount - 1, 3) = Format(TotalRubro, "#,##0")
...
Dim Columnas As Integer
    ...
    With ex
        ...
        .Range("A5").Select
        .ActiveCell.FormulaR1C1 = "Centro de Costos: " & TxtCentroEmisor.Text
        .Range("A6").Select
