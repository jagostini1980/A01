...
Begin VB.Form A01_5B900 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consulta Rubros Contables Acumulado"
   ClientHeight    =   8010
   ClientLeft      =   3420
   ClientTop       =   3405
   ClientWidth     =   10395
   ...
   Begin DDSharpGrid2.SGGrid GridListado 
      ...
      StylesCollection=   $"A01_5B900.frx":0000
      ColumnsCollection=   "A01_5B900.frx":1DD9
      ValueItems      =   $"A01_5B900.frx":7397
   End
...
On Error GoTo ErrorTraer:
  With RsListado
     '******** Total Gastos Por Rubro ***********
      Sql = "SpOcConsultaRubrosContableAcumulado @PeriodoDesde='" & Format(CalDesde, "yyyyMM") & _
                                             "', @PeriodoHasta='" & Format(CalHasta, "yyyyMM") & _
                                             "', @PresAprobados =" & ChkSoloLosPresSGPAprobados.Value
     .Open Sql, Conec
     Sql = "SpOcConsultaRubrosContableTotalesPresFinancierosAcumulado @PeriodoDesde='" & Format(CalDesde, "yyyyMM") & _
                                                                  "', @PeriodoHasta='" & Format(CalHasta, "yyyyMM") & "'"
...
Dim Arr As SGArray
    ...
    With ex
        ...
        InicioTabla2 = 5
         ...
         Call FormatearExcelGrid(ex, InicioTabla2, Fila - InicioTabla2 - 1, 5, ColorFondo)
         .Range("A" & Fila).Select
        ...
        .Range("A3").Select
        .ActiveCell.FormulaR1C1 = "Período: " & Format(CalDesde.Value, "MMMM/yyyy") & " Hasta " & Format(CalHasta.Value, "MMMM/yyyy")
...
Private Sub ConfImpresionDeConsulta()
  ...
  Dim RsListado As New ADODB.Recordset
    ...
    If Not RsListado.EOF Then
       RsListado.MoveFirst
    End If
    ListA01_5B900.TxtPeriodo = Format(CalDesde.Value, "MMMM/yyyy") & " Hasta " & Format(CalHasta.Value, "MMMM/yyyy")
    ListA01_5B900.DataControl1.Recordset = RsListado
    ListA01_5B900.Zoom = -1
End Sub
