...
Begin VB.Form A01_5B110 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Estado de Presupuesto - Detalle Movilidad"
   ClientHeight    =   8055
   ClientLeft      =   -4710
   ClientTop       =   -1755
   ClientWidth     =   8535
   ...
   Begin DDSharpGrid2.SGGrid GridListado 
      ...
      StylesCollection=   $"A01_5B110.frx":0000
      ColumnsCollection=   "A01_5B110.frx":1DD9
      ValueItems      =   $"A01_5B110.frx":6075
   End
...
Dim TotUsado As Double
    ...
    Sql = "SpOcConsultaEstadoDePresuestoDetalleMovilidad @CentroEmisor ='" & VecCentroDeCostoEmisor(CmbCentroDeCostoEmisor.ListIndex).C_Codigo & _
    ...
    With TbListado
        ...
        While Not .EOF
            ...
            GridListado.Array(i, 0) = !CentroDeCosto
            GridListado.Array(i, 1) = BuscarDescCentro(!CentroDeCosto)
