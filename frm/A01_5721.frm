...
On Error GoTo Error
    ...
    'Realiza la consulta
    Sql = "SpOcConsultaDetallePorCuentaContableAcumularProv @Periodo  ='" & Format(Periodo, "MM/yyyy") & _
    ...
    With RsCargar
      ...
      LvListado.Sorted = False
        While Not .EOF
            ...
            LvListado.ListItems(i).Text = !C_Proveedor
            LvListado.ListItems(i).SubItems(1) = IIf(!C_Proveedor = 0, "(Sin Proveedor)", BuscarDescProv(!C_Proveedor))
